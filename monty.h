...
/**
 * struct stack_s - description for the doubly linked list of a stack (or queue)
 * @n: points to the integer "n"
 * @prev: points to the prev of the stack (or queue)
 * @next: points to the next of the stack (or queue)
 *
 ...
 * @opcode: points to the opcode
 * @f: points to the function to handle the opcode
 *
 ...
 * @arr: array of words
 * @n: points to the integer to pass to instruction
 * @file: points to the file to be read
 * @entry: points to the specified entry either stack or queue
 * @read_len: points to the read number of length
